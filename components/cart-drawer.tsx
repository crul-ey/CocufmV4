    ...
    <>
              ...
              <div className="flex-1 overflow-y-auto py-4 space-y-3 px-1">
                {cartItems.map(({ node: item }, index) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className={`group relative p-4 bg-white dark:bg-stone-800 rounded-2xl border border-stone-200 dark:border-stone-700 shadow-sm hover:shadow-md transition-all duration-300 ${
                        isUpdating
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex-1 min-w-0 pr-2">
                              <h4 className="font-bold text-stone-900 dark:text-stone-100 truncate text-base sm:text-lg">
                            ...
                            <Button
                              ...
                              className="text-red-500 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 p-2 rounded-full opacity-0 group-hover:opacity-100 sm:opacity-100 transition-all duration-300 flex-shrink-0"
                            >
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center bg-stone-100 dark:bg-stone-700 rounded-full p-1">
                              <Button
                                ...
                                className="w-8 h-8 rounded-full hover:bg-white dark:hover:bg-stone-600 transition-colors touch-manipulation"
                              >
                            ...
                            <div className="text-right">
                              <div className="font-bold text-base sm:text-lg text-stone-900 dark:text-stone-100">
                                {linePrice
                                  ? formatPrice(
                                      lineTotalAmount,
      ...
      {showRemoveConfirm && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[60] p-4">
          <div className="bg-white dark:bg-stone-800 rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl">
